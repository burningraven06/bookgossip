...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { address: @publisher.address, cover_page: @publisher.cover_page, name: @publisher.name, website: @publisher.website } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { address: @publisher.address, cover_page: @publisher.cover_page, name: @publisher.name, website: @publisher.website } }
